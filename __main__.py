...
async def food(event: bot.SimpleBotEvent):
    ...
    ordered = f"На сегодня заказано: {history[0]['complex__name']}\nСтатус заказа: {history[0]['state_str']}" if history else "На сегодня ничего не заказано."
